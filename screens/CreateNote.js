      ...
      <View style={styles.contenedorPadre}>
        <View style={styles.tarjeta}>
          <View style={styles.contenedor}>
            ...
            />
            <TextInput 
              placeholder="Ingresa al detalle" 
              multiline={true} 
              numberOfLines={ 4 } 
              style={styles.textoInput}
            ...
            <View style={styles.inputDate}>
              <TextInput placeholder="23/11/2023" style={styles.textoDate} value={fecha}/>
            ...
            <View style={styles.inputDate}>
              <TextInput placeholder="Hora: 6 : 30" style={styles.textoDate} value={hora}/>
            ...
            <View>
              <TouchableOpacity style={styles.botonEnviar} onPress={saveNote}>
                <Text style={styles.textoBtnEnviar}>Guardar una Publicaion </Text>
              </TouchableOpacity>
            </View>
          </View>
        </View>
